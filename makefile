...
.PHONY: help venv install poetry-install lint format test test-coverage build clean error
...
poetry-install:
	...
	$(POETRY) install || make error MESSAGE="Failed to install dependencies with Poetry."
